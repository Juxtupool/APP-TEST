...
KeyConfig keys[numKeys] = {
  {0, LOW},   // Key 0: D3 (Active LOW)
  {2, LOW},   // Key 1: D4 (Active LOW)
  {4, LOW},   // Key 2: D2 (Active LOW)
  {15, HIGH}, // Key 3: D8 (Active HIGH)
  {5, LOW},   // Key 4: D1 (Active LOW)
  {16, HIGH}  // Key 5: D0 (Active HIGH)
};
